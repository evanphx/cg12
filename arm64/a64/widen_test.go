...
var widenedCases = []string{
	...
	"fabs s0, s1", "fabs d2, d3",
	"fsqrt s0, s1", "fsqrt d2, d3",
	"frintn s0, s1", "frintn d2, d3",
	"frintp s0, s1", "frintp d2, d3",
	"frintm s0, s1", "frintm d2, d3",
	"frintz s0, s1", "frintz d2, d3",
	"frinta s0, s1", "frinta d2, d3",
