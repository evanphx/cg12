...
var moreEncodingCases = []encodingCase{
	...
	{"fabs s2, s3", Fabs(false, 2, 3)},
	{"fabs d0, d1", Fabs(true, 0, 1)},
	{"fabs d31, d30", Fabs(true, 31, 30)},
	{"fsqrt s0, s1", Fsqrt(false, 0, 1)},
	{"fsqrt d0, d1", Fsqrt(true, 0, 1)},
	{"fsqrt d7, d21", Fsqrt(true, 7, 21)},
	{"frintn s4, s5", Frintn(false, 4, 5)},
	{"frintn d0, d1", Frintn(true, 0, 1)},
	{"frintp s4, s5", Frintp(false, 4, 5)},
	{"frintp d0, d1", Frintp(true, 0, 1)},
	{"frintm s4, s5", Frintm(false, 4, 5)},
	{"frintm d0, d1", Frintm(true, 0, 1)},
	{"frintz s4, s5", Frintz(false, 4, 5)},
	{"frintz d0, d1", Frintz(true, 0, 1)},
	{"frinta s4, s5", Frinta(false, 4, 5)},
	{"frinta d0, d1", Frinta(true, 0, 1)},
